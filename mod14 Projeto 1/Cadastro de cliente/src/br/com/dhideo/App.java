...
import br.com.dhideo.dao.ClienteMapDAO;
import br.com.dhideo.dao.ClienteSetDAO;
...
public class App {
    ...
    public static void main(String args[]) {
        ...
        String opcao = JOptionPane.showInputDialog(null,
                "Digite 1 para cadastrar, 2 para consultar, 3 para excluir, 4 para alter ou 5 para sair",
    ...
    private static void excluir(String dados) {
        ...
        JOptionPane.showMessageDialog(null, "Cliente excluído com sucesso: ", "Excluido",JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private static void sair() {
        ...
        JOptionPane.showMessageDialog(null, "Até logo" + clientesCadastrados, "Menssage",JOptionPane.INFORMATION_MESSAGE);
        System.exit(0);
    }

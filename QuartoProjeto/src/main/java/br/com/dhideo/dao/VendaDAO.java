...
import br.com.dhideo.dao.factory.ProdutoQuantidadeFactory;
import br.com.dhideo.dao.factory.VendaFactory;
import br.com.dhideo.dao.generic.GenericDAO;
...
public class VendaDAO extends GenericDAO<Venda, String> implements IVendaDAO {
    ...
    public void finalizarVenda(Venda venda) throws TipoChaveNaoEncontradaException, DAOException {
        ...
        try {
            ...
            stm.setString(1, VendaJpa.Status.CONCLUIDA.name());
    ...
    public void cancelarVenda(Venda venda) throws TipoChaveNaoEncontradaException, DAOException {
        ...
        try {
            ...
            connection = getConnection();
            stm = connection.prepareStatement(sql);
            stm.setString(1, VendaJpa.Status.CANCELADA.name());
            stm.setLong(2, venda.getId());
            stm.executeUpdate();
